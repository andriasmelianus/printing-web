...
@section('body')
    ...
    <div id="msgInstallWCPP" style="display:none;">
        ...
        <p>
            <a href="{{ action([App\Http\Controllers\HomeController::class, 'printESCPOS']) }}">You can go and test the printing page...</a>
        </p>
    ...
    <script type="text/javascript">
        ...
        function wcppDetectOnSuccess() {
            ...
            if (wcppVer.substring(0, 1) == "6")
                window.location.href = "{{ action([App\Http\Controllers\HomeController::class, 'printESCPOS']) }}";
